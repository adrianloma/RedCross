...
<head>
	...
	<script>
		...
		function Buscar(){
		    ...
		    var url="../../controladores/reportes/gridCarreras.php?buscar=" + buscar + "&contiene=" + contiene;
		...
		function ver(id, siglas){
			window.location.assign("menuBoletasAlumnos.php?id_carrera="+id+"&siglas="+siglas);
		}
		...
		<div class="row">
			...
			<article class="col-sm-10 maincontent">
				<header class="page-header">
					<h2 class="page-title" id="titulo">Boletas de calificaciones</h2>
				</header>
