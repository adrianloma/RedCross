...
<head>
	...
	<script>
		...
		function Buscar(){
			...
			document.getElementById('titulo').innerHTML = " Boleta de calificaciones > Alumnos de la carrera: " + unescape(getQueryVariable("siglas")) ;
		    ...
		    var url="../../controladores/reportes/gridAlumno.php?buscar=" + buscar + "&contiene=" + contiene + "&id_carrera=" + unescape(getQueryVariable("id_carrera"));
		...
		function ver(id, nombre){
			window.location.assign("boletaAlumno.php?id_carrera="+getQueryVariable("id_carrera")+
		...
		<div class="row">
			...
			<article class="col-sm-10 maincontent">
				<header class="page-header">
					<h2 class="page-title" id="titulo">Boleta de calificaciones</h2>
				</header>
