...
<body class="home" onload="search()">
	...
	<div class="container text-center">
		<h2 class="thin">Baja de Maestros</h2>
		<br>
	</div>
	<!-- /Intro-->
	...
	<div class="">
		<div class="container">
			<div class="row">
				<form method="post" onsubmit="return validarMatricula()" action="../../controladores/bajas/maestro.php">
					<input type="hidden"  id="matricula" name="matricula" value="">
				<!-- CURP del alumno -->
				<div class="form-group">
					<label for="" class="col-lg-2 control-label">Nombre(s)</label>
					<div class="col-lg-10">
						<input type="text" class="form-control" id="m_nombre" name="m_nombre" placeholder="Nombre(s)" disabled>
					</div>
				</div>
				<br><br>
				<div class="form-group">
					...
					<div class="col-lg-10">
						<input type="text" class="form-control" id="m_apellidopaterno" name="m_apellidopaterno" placeholder="Apellido Paterno" disabled>
					</div>
				</div>
				<br><br>
				<div class="form-group">
					...
					<div class="col-lg-10">
						<input type="text" class="form-control" id="m_apellidomaterno" name="m_apellidomaterno" placeholder="Apellido Materno" disabled>
					</div>
				</div>
				<br><br>
				<div class="form-group">
					...
					<div class="col-lg-10">
						<select class="form-control" id="m_sexo" name="m_sexo" required disabled>
							<option value="">-</option>
				...
				<div class="form-group">
					...
					<div class="col-lg-10">
						<input type="text" class="form-control" onchange="isFloat('m_edad')" id="m_edad" name="m_edad" placeholder="Edad (n&uacutemero)" disabled>
					</div>
				</div>
				<br><br>	
				<div class="form-group">
					...
					<div class="col-lg-10">
						<select class="form-control" id="m_estadocivil" name="m_estadocivil" required disabled>
							<option value="">-</option>
				...
				<div class="form-group">
					...
					<div class="col-lg-10">
						<input type="date" class="form-control" id="m_fechanac" name="m_fechanac" placeholder="dd/mm/aaaa" disabled>
					</div>
				</div>
				<br><br>
				<div class="form-group">
					...
					<div class="col-lg-10">
						<input type="text" class="form-control" id="m_lugarnac" name="m_lugarnac" placeholder="Lugar de Nacimiento" disabled>
					</div>
				</div>
				<br><br>
				<div class="form-group">
					...
					<div class="col-lg-10">
						<input type="text" class="form-control" id="m_nacionalidad" name="m_nacionalidad" placeholder="Nacionalidad" disabled>
					</div>
				</div>
				<br><br>
				<div class="form-group">
					...
					<div class="col-lg-10">
						<input type="text" class="form-control" id="m_curp" name="m_curp" placeholder="CURP" disabled>
					</div>
				</div>
				<br><br>
				<div class="form-group">
					...
					<div class="col-lg-10">
						<select class="form-control" id="m_gposanguineo" name="m_gposanguineo" required disabled>
							<option value="">-</option>
				...
				<div class="form-group">
					...
					<div class="col-lg-10">
						<input type="text" class="form-control" id="m_rh" name="m_rh" placeholder="RH" disabled>
					</div>
				</div>
				<br><br>
				<div class="form-group">
					...
					<div class="col-lg-10">
						<input type="text" class="form-control" id="m_servmedico" name="m_servmedico" placeholder="Servicio médico" disabled>
					</div>
				</div>
				<br><br>				
				<div class="form-group">
					...
					<div class="col-lg-10">
						<input type="text" class="form-control" id="m_trabajo" name="m_trabajo" placeholder="Liste su trabajo, omitir en caso de no tener" disabled>
					</div>
				</div>
				<br><br>
				<div class="form-group">
					...
					<div class="col-lg-10">
						<input type="text" class="form-control" id="m_escolaridad" name="m_escolaridad" placeholder="Escolaridad" disabled>
					</div>
				</div>
				<br><br>
				<div class="form-group">
					...
					<div class="col-lg-10">
						<input type="text" class="form-control" id="m_otrosestudios" name="m_otrosestudios" placeholder="Liste si ha realizado otros estudios, omitir en caso de no tener" disabled>
					</div>
				</div>
				<br><br>
				<div class="form-group">
					...
					<div class="col-lg-10">
						<input type="text" class="form-control" id="m_enfermedades" name="m_enfermedades" placeholder="Liste enfermedades que padece, omitir en caso de no tener" disabled>
					</div>
				</div>
				<br><br>
				<div class="form-group">
					...
					<div class="col-lg-10">
						<input type="text" class="form-control" id="m_alergias" name="m_alergias" placeholder="Liste alergias que padece, omitir en caso de no tener" disabled>
					</div>
				</div>
				<br><br>
				<div class="form-group">
					...
					<div class="col-lg-10">
						<input type="text" class="form-control" id="m_debilidadmotriz" name="m_debilidadmotriz" placeholder="Liste debilidades motrices que padece, omitir en caso de no tener" disabled>
					</div>
				</div>
				<br><br>			
				...
				<div class="form-group">
					...
					<div class="col-lg-10">
						<input type="text" class="form-control" onchange="isFloat('m_cp')" id="m_numlocal" name="m_numlocal" placeholder="Tel&eacute;fono" disabled>
					</div>
				</div>
				<br><br>
				<div class="form-group">
					...
					<div class="col-lg-10">
						<input type="text" class="form-control" onchange="isFloat('m_numcelular')" id="m_numcelular" name="m_numcelular" placeholder="Tel&eacute;fono celular" disabled>
					</div>
				</div>
				<br><br>
				<div class="form-group">
					...
					<div class="col-lg-10">
						<input type="email" class="form-control" id="m_email" name="m_email" placeholder="Email" disabled>
					</div>
				</div>
				<br><br>	
				<div class="form-group">
					...
					<div class="col-lg-10">
						<input type="text" class="form-control" id="m_domicilio" name="m_domicilio" placeholder="Direcci&oacute;n con numero ext/int" required disabled>
					</div>
				</div>
				<br><br>
				<div class="form-group">
					...
					<div class="col-lg-10">
						<input type="text" class="form-control" onchange="isFloat('m_cp')" id="m_cp" name="m_cp" placeholder="C&oacute;digo postal" required disabled>
					</div>
				</div>
				<br><br>
				<div class="form-group">
					...
					<div class="col-lg-10">
						<input type="text" class="form-control" id="m_colonia" name="m_colonia" placeholder="Colonia" required disabled>
					</div>
				</div>
				<br><br>
				<div class="form-group">
					...
					<div class="col-lg-10">
						<input type="text" class="form-control" id="m_municipio" name="m_municipio" placeholder="Municipio" required disabled>
					</div>
				</div>
				<br><br>
				<div class="form-group">
					...
					<div class="col-lg-10">
						<input type="text" class="form-control" onchange="isFloat('m_numext')" id="m_numext" name="m_numext" placeholder="N&uacute;mero exterior" required disabled>
					</div>
				</div>
				<br><br>
				<div class="form-group">
					...
					<div class="col-lg-10">
						<input type="text" class="form-control" onchange="isFloat('m_numint')" id="m_numint" name="m_numint" placeholder="N&uacute;mero interior" required disabled>
					</div>
				</div>
				<br><br>
				<div class="form-group">
