...
<body class="home" onload="search()">
	...
	<div class="container text-center">
		<h2 class="thin">Bajas de grupos</h2>
		<br>
	</div>
	<!-- /Intro-->
	...
	<div class="">
		<div class="container">
			<div class="row">
				<form method="post" action="../../controladores/bajas/grupo.php">
					<input type="hidden" id="matricula" value="" name="matricula">
					<div class="form-group">
						<label for="" class="col-lg-2 control-label">Nombre del Grupo</label>
						<div class="col-lg-10">
							<input type="text" class="form-control" id="grupo" name="grupo" placeholder="Ejemplo: 1A" readonly>
						</div>
					</div>
					<br><br>
					<br><br>
