<?php
  ...
  $query = "SELECT 
                m.id_maestro,     m.m_nombre,           m.m_apellidopaterno,  m.m_apellidomaterno,  m.m_email,
                ca.c_nombre,      n.ne_desc,            g.gru_nombre,         c.cu_nombre,          c.cu_objetivo,
                c.cu_numunidades, c.cu_fecharegistro,   c.cu_aula,            c.cu_dias,            c.cu_horaInicio,
                c.cu_horaFinal,   c.cu_isPrioridadAlta
            FROM
                maestro m
                    INNER JOIN
  ...
  $headings = array(  'id_maestro',      'm_nombre',           'm_apellidopaterno',  'm_apellidomaterno',  'm_email',
                      ...
                      'cu_numunidades',  'cu_fecharegistro',   'cu_aula',            'cu_dias',            'cu_horaInicio',
                      'cu_horaFinal',    'cu_isPrioridadAlta');
