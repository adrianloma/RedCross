		...
		<div class="row">
			...
			<article class="col-sm-9 maincontent">
				<header class="page-header">
					<h1 class="page-title">Generador de reportes: Administradores</h1>
				</header>
				<div>
					<a href="../../controladores/reportes/reporteAdministradores.php">
					<input class="btn btn-action" style="width:100%;" type="submit" value="Todos los administradores con sus permisos">
					</a>
				</div>
				<br>
				<div>
